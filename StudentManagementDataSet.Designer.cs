...
namespace StudentManagementSystem {
    ...
    public partial class StudentManagementDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(string FirstName, string LastName, string Address, string EmailAddress, System.DateTime DOB, string FatherName, string MotherName, string Occupation, int PhoneNumber, string Courses) {
        ...
        public partial class StudentRow : global::System.Data.DataRow {
            ...
            public string Occupation {
                get {
                    return ((string)(this[this.tableStudent.OccupationColumn]));
                }
                set {
                    this[this.tableStudent.OccupationColumn] = value;
                }
            }
...
namespace StudentManagementSystem.StudentManagementDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([FirstName], [LastName], [Address], [EmailAddress], [DOB], [FatherName], [MotherName], [Occupation], [PhoneNumber], [Courses]) VALUES (@FirstName, @LastName, @Address, @EmailAddress, @DOB, @FatherName, @MotherName, @Occupation, @PhoneNumber, @Courses);
SELECT Id, FirstName, LastName, Address, EmailAddress, DOB, FatherName, MotherName, Occupation, PhoneNumber, Courses FROM Student WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [FirstName] = @FirstName, [LastName] = @LastName, [Address] = @Address, [EmailAddress] = @EmailAddress, [DOB] = @DOB, [FatherName] = @FatherName, [MotherName] = @MotherName, [Occupation] = @Occupation, [PhoneNumber] = @PhoneNumber, [Courses] = @Courses WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Address] = @Original_Address) AND ((@IsNull_EmailAddress = 1 AND [EmailAddress] IS NULL) OR ([EmailAddress] = @Original_EmailAddress)) AND ([DOB] = @Original_DOB) AND ([FatherName] = @Original_FatherName) AND ([MotherName] = @Original_MotherName) AND ([Occupation] = @Original_Occupation) AND ([PhoneNumber] = @Original_PhoneNumber) AND ((@IsNull_Courses = 1 AND [Courses] IS NULL) OR ([Courses] = @Original_Courses)));
SELECT Id, FirstName, LastName, Address, EmailAddress, DOB, FatherName, MotherName, Occupation, PhoneNumber, Courses FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StudentManagementSystem.Properties.Settings.Default.StudentManagementConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Address, EmailAddress, DOB, FatherName, MotherNam" +
                "e, Occupation, PhoneNumber, Courses FROM dbo.Student";
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_Address, string Original_EmailAddress, System.DateTime Original_DOB, string Original_FatherName, string Original_MotherName, string Original_Occupation, int Original_PhoneNumber, string Original_Courses) {
            ...
            this.Adapter.DeleteCommand.Parameters[10].Value = ((int)(Original_PhoneNumber));
        ...
        public virtual int Insert(string FirstName, string LastName, string Address, string EmailAddress, System.DateTime DOB, string FatherName, string MotherName, string Occupation, int PhoneNumber, string Courses) {
            if ((FirstName == null)) {
            ...
            if ((Courses == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[9].Value = ((string)(Courses));
            }
        ...
        public virtual int Update(
            ...
            if ((Courses == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Courses));
            }
            ...
            if ((Original_MotherName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_MotherName));
            }
            if ((Original_Occupation == null)) {
                throw new global::System.ArgumentNullException("Original_Occupation");
            }
            ...
            if ((Original_Courses == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_Courses));
            }
        ...
        public virtual int Update(
                    ...
                    int Original_PhoneNumber, 
                    string Original_Courses) {
            return this.Update(FirstName, LastName, Address, EmailAddress, DOB, FatherName, MotherName, Occupation, PhoneNumber, Courses, Original_Id, Original_FirstName, Original_LastName, Original_Address, Original_EmailAddress, Original_DOB, Original_FatherName, Original_MotherName, Original_Occupation, Original_PhoneNumber, Original_Courses, Original_Id);
        }
    }
